...
loghandler = {
    ...
    noturl: {
    	status: false,
    	code: 403,
    	message: '[!] Forbiden, Erro, URL inválido',
    	maintanied_by: `${creator}`
    },
    notfound: {
    	status: false,
    	code: 404,
    	message: '[!] Forbiden, erro página não encontrada',
    	maintanied_by: `${creator}`
    },
    notid: {
    	status: false,
    	code: 404,
    	message: '[!] Forbiden, Erro, ID ou Zona Inválida',
    	maintanied_by: `${creator}`
    },
    redy: {
    	status: false,
    	code: 403,
    	message: '[!] Forbiden, Erro, Alias ​​já em uso'',
    	maintanied_by: `${creator}`
    },
    emoji: {
	    status: false,
	    code: 403,
	    message: '[!] Forbiden, Erro, Emoji não encontrado',
	    maintanied_by: `${creator}`
   },
    register: {
	    status: false,
	    code: 403,
	    message: '[!] REGISTRA-SE PRIMEIRO.',
  },
   verify: {
	    status: false,
	    code: 403,
	    message: '[!] por gentileza, verifique seu email.',
}
